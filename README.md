...
|L-RMSE,  R-RMSE,  LR-RMSE                            |R+     |Value     |$$ L-RMSE(\boldsymbol{y,\hat{y}}) = \sqrt{\frac{\sum_{i}(y_i-\hat{y}_i)^2\cdot\boldsymbol{1}\{y_i\leq\iota\}}{\sum_{i}\boldsymbol{1}\{ y_i\leq\iota\}}}$$ <br> $$R-RMSE(\boldsymbol{y,\hat{y}})=\sqrt{\frac{\sum_{i}(y_i-\hat{y}_i)^2\cdot \boldsymbol{1}\{y_i\geq\gamma\}}{\sum_{i}\boldsymbol{1}\{ y_i\geq\gamma\}}}$$ <br> $$LR-RMSE(\boldsymbol{y,\hat{y}})=\sqrt{\frac{\sum_{i}(y_i-\hat{y}_i)^2\cdot\boldsymbol{1}\{(y_i\leq\iota)or(y_i\geq\gamma)\}}{\sum_{i} \boldsymbol{1}\{(y_i\leq\iota)or(y_i\geq\gamma)\}}}$$ <br> <img src=".\response_suppl\formula1.png" alt="formula1" style="zoom:40%;" /> |
